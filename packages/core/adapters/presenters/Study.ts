...
import IStudyUseCase from "../../domains/useCases/interfaces/iStudy";
import IMemberEntity from "../../domains/entities/interfaces/iMember";
import { IStudyPreviewDTO } from "../../domains/dto/StudyDTO";
import IStudyEntity from "../../domains/entities/interfaces/iStudy";
