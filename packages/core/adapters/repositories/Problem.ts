import ProblemDTO, { IProblemDTO, IProblemParams } from "../../domains/dto/ProblemDTO";
import IProblemRepository from "../../domains/useCases/repository-interfaces/iProblem";
