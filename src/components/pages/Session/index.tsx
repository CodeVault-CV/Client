...
export default function SessionContainer() {
  ...
  const {
    ...
    data: session,
  } = useQuery(["session"], () => getSession(sessionId).then((res) => res.data));
  const {
    isLoading: problemListLoading,
    isError: problemListError,
    data: problemList,
  } = useQuery(["problemList"], () => getProblemList(sessionId).then((res) => res.data));
