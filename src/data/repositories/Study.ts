import MemberDTO, { IMemberDTO, IMemberParams } from "../../core/dto/MemberDTO";
import StudyDTO, {
  IStudyDTO,
  IStudyParams,
  StudyPreviewDTO,
} from "../../core/dto/StudyDTO";
import { IStudyPreviewEntity } from "../../core/entities/interfaces/iStudy";
import IStudyRepository from "../../core/useCases/repository-interfaces/iStudy";
